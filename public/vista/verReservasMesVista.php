        ...
        <div class="page-title">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Reservas del Mes</li>
                </ol>
            </nav>
        </div>
...
<?php endif; ?>
                ...
                <div class="content-box-body">
                    <div class="row align-items-center">
                        <div class="col-md-4 text-center text-md-start">
                            <a href="AreaComunControlador.php?action=verReservasMes&mes=<?php echo $mesAnterior; ?>"
                        ...
                        <div class="col-md-4 text-center">
                            ...
                            <small class="text-muted">Total de reservas: <?php echo count($reservas); ?></small>
                        </div>
                        <div class="col-md-4 text-center text-md-end">
                            <a href="AreaComunControlador.php?action=verReservasMes&mes=<?php echo $mesSiguiente; ?>"
                               class="btn btn-outline-primary">
    ...
    <!-- Estadísticas de Reservas del Mes -->
    <div class="row fade-in mb-4">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="content-box text-center">
                <div class="content-box-body">
                    ...
                    <p class="text-muted mb-0">Áreas con Reservas</p>
                </div>
            </div>
        </div>
    </div>

    <!-- Tabla de Reservas del Mes -->
    <div class="row fade-in">
        <div class="col-12">
            <div class="content-box">
                <div class="content-box-header d-flex justify-content-between align-items-center">
                    <h5>Reservas del Mes - <?php echo $nombreMes . ' ' . $anio; ?></h5>
                ...
                <div class="content-box-body">
                    <?php if (empty($reservas)): ?>
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">No hay reservas registradas para este mes</p>
                            <a href="AreaComunControlador.php?action=verReservasMes&mes=<?php echo date('Y-m'); ?>"
                               class="btn btn-primary mt-2">
                                <i class="fas fa-calendar me-2"></i>Ver Mes Actual
                            </a>
                        </div>
                    <?php else: ?>
                        <div class="table-container">
                            <table id="tablaReservasMes" class="table table-hover table-striped">
                                <thead>
                                <tr>
                                    <th>#</th>
                                        ...
                                        <td>
                                            <?php if ($reserva['motivo']): ?>
                                                <button class="btn btn-info btn-sm"
                                                        ...
                                                        data-area="<?php echo htmlspecialchars($reserva['area_nombre']); ?>"
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <?php if ($reserva['estado'] != 'confirmada'): ?>
                                                    <button class="btn btn-success btn-sm"
                                                            ...
                                                            data-persona="<?php echo htmlspecialchars($nombreCompleto); ?>"
                                                            data-area-nombre="<?php echo htmlspecialchars($reserva['area_nombre']); ?>"
    ...
    <!-- Modal Ver Motivo - IDÉNTICO AL DE verReservasAreaVista -->
    ...
    <!-- Script para DataTable y funcionalidades - IDÉNTICO AL DE verReservasAreaVista -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Inicializar DataTable
            var tabla = $('#tablaReservasMes').DataTable({
                language: {
                ...
                buttons: [
                    {
                        ...
                        title: 'Reporte de Reservas del Mes - <?php echo $nombreMes . " " . $anio; ?>',
                        filename: 'reservas_mes_<?php echo strtolower($nombreMes) . "_" . $anio; ?>',
                        exportOptions: {
                            columns: [0, 1, 2, 3, 4, 5, 6], // Quitamos Motivo(7) y Acciones(8)
                            stripHtml: true,
                            stripNewlines: true,
                            format: {
                        ...
                        customize: function (doc) {
                                    ...
                                    columns: [
                                        ...
                                        },
                                        {
                                            stack: [
                                                ...
                                                { text: 'Reporte de Reservas del Mes', style: 'reportTitle' }
                                            ],
                                            width: '60%',
                                            alignment: 'center'
                                        },
                            ...
                            // Información del mes con diseño de tarjeta
                                                ...
                                                columns: [
                                                    {
                                                        width: '50%',
                                                        stack: [
                                                            { text: `Mes: <?php echo $nombreMes . " " . $anio; ?>`, style: 'fieldTitle' },
                                                            { text: `Total de Reservas: <?php echo count($reservas); ?>`, style: 'fieldValue' },
                                                            { text: `Áreas con Reservas: <?php echo count(array_unique(array_column($reservas, 'id_area'))); ?>`, style: 'fieldValue' }
                                                        ]
                                                    },
                                                    {
                                                        width: '50%',
                                                        stack: [
                                                            { text: `Pendientes: <?php echo count(array_filter($reservas, function($r) { return $r["estado"] == "pendiente"; })); ?>`, style: 'fieldValue', color: '#f39c12' },
                                                            { text: `Confirmadas: <?php echo count(array_filter($reservas, function($r) { return $r["estado"] == "confirmada"; })); ?>`, style: 'fieldValue', color: '#27ae60' },
                                                            { text: `Canceladas: <?php echo count(array_filter($reservas, function($r) { return $r["estado"] == "cancelada"; })); ?>`, style: 'fieldValue', color: '#e74c3c' }
                                                        ]
                                                    }
                                                ],
                                                margin: [10, 10, 10, 10]
                            ...
                            if (doc.content[4].table) {
                                ...
                                doc.content[4].table.widths = ['5%', '20%', '20%', '15%', '10%', '15%', '15%'];
                            ...
                            doc.footer = function(currentPage, pageCount) {
                                return {
                                    columns: [
                                        {
                                            text: `Sistema de Edificio Inteligente - Página ${currentPage.toString()} de ${pageCount}`,
                                            alignment: 'center',
                                            fontSize: 8,
                                            color: '#95a5a6',
                                            margin: [0, 10, 0, 0]
                    ...
                    },
                    {
                        ...
                        title: 'Reservas_Mes_<?php echo $nombreMes . "_" . $anio; ?>',
                        filename: 'reservas_mes_<?php echo strtolower($nombreMes) . "_" . $anio; ?>',
                        exportOptions: {
                            columns: [0, 1, 2, 3, 4, 5, 6], // Quitamos Motivo(7) y Acciones(8)
                            format: {
                    ...
                    },
                    {
                        ...
                        title: 'SEINT - Reservas del Mes - <?php echo $nombreMes . " " . $anio; ?>',
                        exportOptions: {
                            columns: [0, 1, 2, 3, 4, 5, 6], // Quitamos Motivo(7) y Acciones(8)
                            stripHtml: false,
                            format: {
                        ...
                        customize: function (win) {
                            ...
                            var mesInfo = `
                                <div style="margin-bottom: 25px; padding: 20px; border: 2px solid #3498db; border-radius: 10px; background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
                                    <h4 style="color: #2c3e50; text-align: center; margin-bottom: 15px;">
                                        <i class="fas fa-calendar-alt"></i> Reservas del Mes - <?php echo $nombreMes . " " . $anio; ?>
                                    </h4>
                                    <div style="display: flex; justify-content: space-between;">
                                        <div style="width: 48%;">
                                            <p><strong>Total de Reservas:</strong> <?php echo count($reservas); ?></p>
                                            <p><strong>Áreas con Reservas:</strong> <?php echo count(array_unique(array_column($reservas, 'id_area'))); ?></p>
                                        </div>
                                        <div style="width: 48%;">
                                            <p><strong>Pendientes:</strong> <span style="color: #f39c12"><?php echo count(array_filter($reservas, function($r) { return $r["estado"] == "pendiente"; })); ?></span></p>
                                            <p><strong>Confirmadas:</strong> <span style="color: #27ae60"><?php echo count(array_filter($reservas, function($r) { return $r["estado"] == "confirmada"; })); ?></span></p>
                                            <p><strong>Canceladas:</strong> <span style="color: #e74c3c"><?php echo count(array_filter($reservas, function($r) { return $r["estado"] == "cancelada"; })); ?></span></p>
                                        </div>
                                    </div>
                                </div>
                            `;

                            $(win.document.body).prepend(mesInfo);
                            ...
                            var header = `
                                <div style="text-align: center; margin-bottom: 20px; padding: 15px; border-bottom: 3px solid #3498db;">
                                    ...
                                    <p style="color: #95a5a6; margin: 0;">Reporte de Reservas del Mes</p>
                                </div>
                            `;
                ...
                initComplete: function() {
                    ...
                    this.api().buttons().container().appendTo('#tablaReservasMes_wrapper .col-md-6:eq(1)');
                }
            });

            // Modal Ver Motivo - MEJORADO (igual que verReservasAreaVista)
    ...
    <!-- Estilos adicionales - IDÉNTICOS AL DE verReservasAreaVista -->
    <style>
        .content-box-header {
