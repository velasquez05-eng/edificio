<?php include("../../includes/header.php"); ?>
    ...
    <div class="page-header fade-in">
        <div class="page-title">
            <h1>Historial Completo de Pagos</h1>
        ...
        <div class="col-md-3">
            <div class="content-box text-center">
                <div class="content-box-body">
                    ...
                    <p class="text-muted mb-0">Total Recaudado</p>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="content-box text-center">
                <div class="content-box-body">
                    ...
                    <h4 class="mb-1"><?php echo $estadisticas['departamentos_con_pagos']; ?></h4>
        ...
        <div class="col-12">
            <div class="content-box">
                <div class="content-box-header">
                    <h5><i class="fas fa-chart-bar me-2"></i>Resumen General de Pagos</h5>
                </div>
                <div class="content-box-body">
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-0"><?php echo $estadisticas['personas_que_pagaron']; ?> Personas</h6>
                                    <small class="text-muted">Realizaron pagos</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-0"><?php echo $estadisticas['primer_pago_formateado']; ?></h6>
                                    <small class="text-muted">Primer pago registrado</small>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
        ...
        <div class="col-12">
            <div class="content-box">
                <div class="content-box-header d-flex justify-content-between align-items-center">
                    <h5>Historial Completo de Pagos</h5>
                    <div>
                        <span class="badge bg-primary"><?php echo count($pagos); ?> registros</span>
                        <button class="btn btn-outline-success btn-sm ms-2" onclick="exportarPagos()">
                ...
                <div class="content-box-body">
                    ...
                    <?php else: ?>
                        <div class="table-container">
                            <table id="tablaPagosCompleto" class="table table-hover table-striped">
                                <thead>
                                <tr>
                                    <th># Pago</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <strong><?php echo htmlspecialchars($pago['residente']); ?></strong>
                                                    <br>
                                                    <small class="text-muted">
                                                        CI: <?php echo htmlspecialchars($pago['ci']); ?>
                                                    </small>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <button class="btn btn-info btn-sm ver-pago"
                                                        ...
                                                        data-departamento="D<?php echo $pago['departamento']; ?>-P<?php echo $pago['piso']; ?>"
                                                        data-residente="<?php echo htmlspecialchars($pago['residente']); ?>"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="detallesPagoModalLabel">
                        <i class="fas fa-receipt me-2"></i>Detalles Completos del Pago
                    </h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="mb-0" id="modalDepartamento">-</p>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold text-primary">Residente:</label>
                                <p class="mb-0" id="modalResidente">-</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var tabla = $('#tablaPagosCompleto').DataTable({
                language: {
                ...
                buttons: [
                    {
                        ...
                        title: 'Historial_Pagos_Completo'
                    },
                    {
                        extend: 'pdf',
                ...
                initComplete: function() {
                    ...
                    this.api().buttons().container().appendTo('#tablaPagosCompleto_wrapper .col-md-6:eq(0)');
                }
            });
            ...
            detallesPagoModal.addEventListener('show.bs.modal', function(event) {
                ...
                document.getElementById('modalDepartamento').textContent = pagoData.departamento;
                document.getElementById('modalResidente').textContent = pagoData.residente;
