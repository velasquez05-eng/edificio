    ...
    <div class="page-header fade-in">
        ...
        <div class="page-actions">
            <a href="../vista/RegistrarPersonaVista.php" class="btn btn-success">
                Registrar Residente <i class="fas fa-user-plus me-2"></i>
            </a>
        </div>
    </div>
                ...
                <div class="content-box-body">
                    <?php if (empty($residentes)): ?>
                        <div class="text-center py-4">
                            ...
                            <a href="../vista/RegistrarPersonaVista.php" class="btn btn-success">
                                <i class="fas fa-user-plus me-2"></i>Registrar Primer Residente
                            </a>
                        </div>
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table table-hover table-striped">
                                ...
                                <?php foreach ($residentes as $residente): ?>
                                    <tr>
                                        <td><strong><?php echo htmlspecialchars($residente['id_persona']); ?></strong></td>
                                        <td>
                                            <i class="fas fa-user text-primary me-2"></i>
                                            <?php echo htmlspecialchars($residente['nombre'] . ' ' . $residente['apellido_paterno'] . ' ' . $residente['apellido_materno']); ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <?php echo htmlspecialchars($residente['telefono']); ?>
                                        </td>
                                        <td>
                                        ...
                                        <span class="badge bg-info">
                                            ...
                                            <?php echo htmlspecialchars($residente['rol']); ?>
                                        </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button class="btn btn-warning btn-sm"
                                                        ...
                                                        data-bs-target="#editarResidenteModal"
                                                        data-id="<?php echo htmlspecialchars($residente['id_persona']); ?>"
                                                        data-nombre="<?php echo htmlspecialchars($residente['nombre']); ?>"
                                                        data-apellido_paterno="<?php echo htmlspecialchars($residente['apellido_paterno']); ?>"
                                                        data-apellido_materno="<?php echo htmlspecialchars($residente['apellido_materno']); ?>"
