<?php
// public/vista/RegistrarComunicadoVista.php
...
?>
    ...
    <div class="page-header fade-in">
        <div class="page-title">
            <h1><?php echo isset($comunicado) ? 'Editar Comunicado' : 'Nuevo Comunicado'; ?></h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i> Inicio</a></li>
                    <li class="breadcrumb-item"><a href="ComunicadoControlador.php">Comunicados</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?php echo isset($comunicado) ? 'Editar' : 'Nuevo'; ?></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="content-box">
                ...
                <div class="content-box-body">
                    <form id="formComunicado" action="ComunicadoControlador.php?action=<?php echo isset($comunicado) ? 'actualizar' : 'registrar'; ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   ...
                                   required
                                   maxlength="255"
                                   value="<?php echo isset($comunicado) ? htmlspecialchars($comunicado['titulo']) : ''; ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control"
                                      ...
                                      rows="8"
                                      required
                                      placeholder="Escriba el contenido del comunicado..."><?php echo isset($comunicado) ? htmlspecialchars($comunicado['contenido']) : ''; ?></textarea>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date"
                                           ...
                                           value="<?php echo isset($comunicado) && $comunicado['fecha_expiracion'] ? date('Y-m-d', strtotime($comunicado['fecha_expiracion'])) : ''; ?>"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="prioridad" name="prioridad" required>
                                        ...
                                        <option value="baja" <?php echo (isset($comunicado) && $comunicado['prioridad'] == 'baja') ? 'selected' : ''; ?>>Baja</option>
                                        <option value="media" <?php echo (isset($comunicado) && $comunicado['prioridad'] == 'media') ? 'selected' : ''; ?>>Media</option>
                                        <option value="alta" <?php echo (isset($comunicado) && $comunicado['prioridad'] == 'alta') ? 'selected' : ''; ?>>Alta</option>
                                        <option value="urgente" <?php echo (isset($comunicado) && $comunicado['prioridad'] == 'urgente') ? 'selected' : ''; ?>>Urgente</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="tipo_audiencia" name="tipo_audiencia" required>
                                        ...
                                        <option value="Todos" <?php echo (isset($comunicado) && $comunicado['tipo_audiencia'] == 'Todos') ? 'selected' : ''; ?>>Todos</option>
                                        <option value="Residente" <?php echo (isset($comunicado) && $comunicado['tipo_audiencia'] == 'Residente') ? 'selected' : ''; ?>>Residente</option>
                                        <option value="Personal" <?php echo (isset($comunicado) && $comunicado['tipo_audiencia'] == 'Personal') ? 'selected' : ''; ?>>Personal</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="estado" name="estado" required>
                                        ...
                                        <option value="borrador" <?php echo (isset($comunicado) && $comunicado['estado'] == 'borrador') ? 'selected' : ''; ?>>Borrador</option>
                                        <option value="publicado" <?php echo (isset($comunicado) && $comunicado['estado'] == 'publicado') ? 'selected' : ''; ?>>Publicado</option>
                                        <option value="archivado" <?php echo (isset($comunicado) && $comunicado['estado'] == 'archivado') ? 'selected' : ''; ?>>Archivado</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div>
                                <button type="submit" class="btn btn-primary">
                                    ...
                                    <?php echo isset($comunicado) ? 'Actualizar Comunicado' : 'Guardar Comunicado'; ?>
                                </button>
                            </div>
                        </div>
                    </form>
