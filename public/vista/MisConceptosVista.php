        ...
        <div class="page-title">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Mis Conceptos</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="content-box text-center">
                <div class="content-box-body">
                    ...
                    <h4 class="mb-1"><?php echo $estadisticas['conceptos_pendientes']; ?></h4>
        ...
        <div class="col-md-3">
            <div class="content-box text-center">
                <div class="content-box-body">
                    ...
                    <h4 class="mb-1"><?php echo $estadisticas['conceptos_facturados']; ?></h4>
                    <p class="text-muted mb-0">Facturados</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="content-box">
                <div class="content-box-header">
                    <h5><i class="fas fa-chart-pie me-2"></i>Resumen de Conceptos</h5>
                </div>
                <div class="content-box-body">
                    <div class="row">
                        <div class="col-md-4">
...
<?php endif; ?>
                ...
                <div class="content-box-body">
                    ...
                    <?php else: ?>
                        <div class="table-container">
                            <table id="tablaConceptos" class="table table-hover table-striped">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <strong class="text-capitalize"><?php echo htmlspecialchars($concepto['concepto']); ?></strong>
                                                    <br>
                                        ...
                                        <td>
                                            <div class="concepto-descripcion">
                                                <strong><?php echo htmlspecialchars(substr($concepto['descripcion'], 0, 60)); ?></strong>
                                                <?php if (strlen($concepto['descripcion']) > 60): ?>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <button class="btn btn-info btn-sm ver-concepto"
                                                        ...
                                                        data-concepto="<?php echo htmlspecialchars($concepto['concepto']); ?>"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="detallesConceptoModalLabel">
                        <i class="fas fa-cube me-2"></i>Detalles del Concepto
                    </h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="mb-0 text-capitalize" id="modalConceptoTipo">-</p>
                            </div>
                            <div class="mb-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var tabla = $('#tablaConceptos').DataTable({
                language: {
